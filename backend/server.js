...
app.post('/Login', async (req, res) => {
    const { email, password  , Username , PhoneNumber , age , country } = req.body;
...
app.delete('/admin/delete-product/:productId', authMid, async (req, res) => {
    try {
        ...
        // Ensure the productId is valid (you might want to add more validation here)
...
app.put('/:id', authMid, async (req, res) => {
...
app.get('/product', async (req, res) => {
  ...
  app.get('/products/:brand', async (req, res) => {
    ...
    try {
      const lenovoProducts = await Product.find({ brand: productbrand });
      res.json(lenovoProducts);
    } catch (error) {
      console.error('Error fetching Lenovo products:', error.message);
